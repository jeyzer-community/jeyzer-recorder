...
public class JzrJstackConfig extends JzrRecorderConfig {

	private static final String JZR_JSTACK = "jstack";
	...
	public JzrJstackConfig(Element recorder) throws Exception {
		super(recorder);
		...
		// jstack node
		Element jstackNode = ConfigUtil.getFirstChildNode(methodsNode, JZR_JSTACK);
		
		this.pid = ConfigUtil.loadIntegerValue(jstackNode, JZR_PID);
		this.options = ConfigUtil.getAttributeValue(jstackNode, JZR_OPTIONS);
